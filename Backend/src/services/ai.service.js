...
if (!apiKey) {
  throw new Error("GOOGLE_GENAI_API_KEY is missing. Add it to Backend/.env");
}
...
Generate the response strictly in valid JSON format.
`;
    ...
    return interviewReportZod.parse(parsedData);
  } catch (error) {
